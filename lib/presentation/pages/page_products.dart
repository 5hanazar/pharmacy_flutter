...
class _ProductsPageState extends State<ProductsPage> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final result = await repo.getProducts(pageKey + 1, _searchTerm);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PagedGridView<int, ProductDto>(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisExtent: (MediaQuery.of(context).size.width / 2) + 160),
      ),
    );
  }
}
